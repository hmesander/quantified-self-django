...
class FoodViewsTest(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.banana = Food.objects.create(id=1, name="banana", calories=80)
        self.oatmeal = Food.objects.create(id=2, name="oatmeal", calories=200)
    ...
    def test_creates_a_food(self):
        response = self.client.post('/api/v1/foods/', {'food': {'id': 5, 'name': 'lucky charms', 'calories': 180}}, format='json')
...
class MealViewsTest(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.breakfast = Meal.objects.create(id=1, name="Breakfast")
        self.snack = Meal.objects.create(id=2, name="Snack")
        self.lunch = Meal.objects.create(id=3, name="Lunch")
        self.dinner = Meal.objects.create(id=4, name="Dinner")
...
class MealFoodViewsTest(TestCase):
    def setUp(self):
        ...
        self.lunch = Meal.objects.create(id=3, name="Lunch")
        self.dinner = Meal.objects.create(id=4, name="Dinner")
        self.banana = Food.objects.create(id=3, name="banana", calories=80)
        self.oatmeal = Food.objects.create(id=4, name="oatmeal", calories=200)
    ...
    def test_associates_food_with_a_meal(self):
        ...
        response = self.client.post('/api/v1/meals/1/foods/3')
        result = response.json()
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_associates_food_with_a_meal(self):
        ...
        response = self.client.delete('/api/v1/meals/1/foods/3')
        result = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
